...
conversationElement.scrollTop = conversationElement.scrollHeight;"
    ...
    <div class="chatbox-header">
        <div class="chatbox-header-info">
            <div class="chatbox-back">
                <a href="{{ url('Consultant/index') }}">
                    <svg fill="#008000" width="25" height="25"
                        viewBox="0 0 200 200" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="chatbox-avatar"><svg width="50px" height="50px" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg" stroke="#008000">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <circle cx="12" cy="9" r="3" stroke="#008000" stroke-width="1.5"></circle>
                        <circle cx="12" cy="12" r="10" stroke="#008000" stroke-width="1.5"></circle>
        ...
        <div class="chatbox-header-icons">
            ...
            <div class="dropdown-content">
                @if ($selectedConversation->status === 'archived')
                    <a href="#" wire:click.prevent="unarchiveChat({{ $selectedConversation->id }})">Unarchive
                        Chat</a>
                @else
                    <a href="#" wire:click.prevent="archiveChat({{ $selectedConversation->id }})">Archive Chat</a>
                @endif
            </div>
        </div>
                ...
                @foreach ($loadedMessages as $message)
                    @if ($message->receiver_id != null)
                        <div class="message received">
                            <div class="avatar"><svg width="40px" height="40px" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" stroke="#008000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <circle cx="12" cy="9" r="3" stroke="#008000" stroke-width="1.5">
                                        </circle>
                                    ...
                                    <a href="{{ asset('storage/' . $message->file_path) }}"
                                        ...
                                        <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-4-4z"
                                                stroke="#008000" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M14 2v6h6M10 12l2 2 2-2M10 16l2 2 2-2" stroke="#008000"
    ...
    <form x-data="{
    ...
    }" wire:submit.prevent="sendMessage" method="POST" enctype="multipart/form-data"
        id="message-form" x-on:livewire-upload-start="uploading = true"
        ...
        <template x-if="fileName">
            <div class="file-display"
                ...
                <button type="button"
                    ...
                    @click="fileName = ''; $refs['file-upload'].value = ''; messageBody = ''" wire:click="removeFile">
                ...
                <div style="text-align: center; margin-bottom: 8px;">
                    <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" stroke="#008000">
                        <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-4-4z" stroke="#008000"
                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M14 2v6h6M10 12l2 2 2-2M10 16l2 2 2-2" stroke="#008000" stroke-width="1.5"
        ...
        <div class="chatbox-footer">
                    ...
                    <div class="icon-wrapper">
                        <label for="file-upload" class="custom-file-upload">
                            <svg class="input-icon-2" width="42px" height="42px" viewBox="0 0 200 200"
                                xmlns="http://www.w3.org/2000/svg" fill="#008000" stroke="#008000">
                                <path
            ...
            <div class="button-container">
                <button type="submit" @click="fileName = ''; $refs['file-upload'].value = ''; messageBody = '';">
